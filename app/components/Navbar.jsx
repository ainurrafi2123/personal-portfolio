    ...
    ${
      isScroll
        ...
        >
          <li>
            <Link href="/#">
              <span className="font-Ovo relative group cursor-pointer">
                Home
                <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-pink-ec transition-all duration-300 group-hover:w-full"></span>
              </span>
            </Link>
          </li>
          <li>
